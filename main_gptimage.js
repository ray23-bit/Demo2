    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        modelSelect.addEventListener('change', function() {
            ...
            } else if (modelSelect.value === 'gptimage') {
                showNotification('GPTImage uses AI-assisted prompts for creative visual output.', 'info');
            }
        });
...
const modelBoosts = {
    ...
    gptimage: "AI-assisted prompt engineering for rich, detailed, and creative visual storytelling"
};
...
} else if (model.value === 'gptimage') {
    fullPrompt += ', ' + modelBoosts.gptimage;
}
